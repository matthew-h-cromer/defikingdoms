...
test('getHero (archival) 1000000306607', async () => {
  const dfk = new DFK();

  const hero = await dfk.getHero('1000000306607', { blockNumber: 27240000 });

  // check immutable hero attrs
  expect(hero).toMatchObject({
    tokenId: '1000000306607',
    summonedTime: new Date('2023-08-01T12:38:04.000Z'),
    nextSummonTime: new Date('2023-08-22T05:22:54.000Z'),
    ...
    shinyStyle: '11',
    staminaFullAt: new Date('2023-12-06T12:17:23.000Z'),
    hpFullAt: null,
    mpFullAt: null,
    level: 3,
    xp: 4000,
