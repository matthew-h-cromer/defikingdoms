export default [
  {
    inputs: [
      { internalType: 'address', name: '_heroCoreAddress', typse: 'address' },
      { internalType: 'address', name: '_geneScienceAddress', type: 'address' },
      { internalType: 'address', name: '_jewelTokenAddress', type: 'address' },
      { internalType: 'address', name: '_gaiaTearsAddress', type: 'address' },
      { internalType: 'address', name: '_statScienceAddress', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: 'owner', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'crystalId', type: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'crystalId', type: 'uint256' },
      { indexed: true, internalType: 'address', name: 'owner', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'summonerId', type: 'uint256' },
      {
        indexed: false,
        internalType: 'uint256',
        name: 'assistantId',
      ...
      { indexed: false, internalType: 'uint16', name: 'generation', type: 'uint16' },
      {
        indexed: false,
        internalType: 'uint256',
        name: 'createdBlock',
      ...
      { indexed: false, internalType: 'uint8', name: 'summonerTears', type: 'uint8' },
      { indexed: false, internalType: 'uint8', name: 'assistantTears', type: 'uint8' },
      { indexed: false, internalType: 'address', name: 'bonusItem', type: 'address' },
    ],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'contract IHeroCore', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint8', name: 'summonerTears', type: 'uint8' },
      { internalType: 'uint8', name: 'assistantTears', type: 'uint8' },
      { internalType: 'address', name: 'bonusItem', type: 'address' },
      { internalType: 'uint32', name: 'maxSummons', type: 'uint32' },
      { internalType: 'uint32', name: 'firstName', type: 'uint32' },
      { internalType: 'uint32', name: 'lastName', type: 'uint32' },
      { internalType: 'uint8', name: 'shinyStyle', type: 'uint8' },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_rarityRoll', type: 'uint256' },
      { internalType: 'uint256', name: '_rarityMod', type: 'uint256' },
    ],
    name: 'determineRarity',
    outputs: [{ internalType: 'enum IHeroTypes.Rarity', name: '', type: 'uint8' }],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'digits', type: 'uint256' },
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_crystalId', type: 'uint256' }],
    name: 'getCrystal',
    outputs: [
      {
        components: [
  ...
  },
  {
    inputs: [],
    name: 'jewelToken',
    outputs: [{ internalType: 'contract IJewelToken', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [
      { internalType: 'address[]', name: '_feeAddresses', type: 'address[]' },
      { internalType: 'uint256[]', name: '_feePercents', type: 'uint256[]' },
    ],
    name: 'setFees',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ internalType: 'address', name: '_geneScienceAddress', type: 'address' }],
  ...
  {
    inputs: [{ internalType: 'address', name: '_statScienceAddress', type: 'address' }],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_newSummonCooldown', type: 'uint256' },
      { internalType: 'uint256', name: '_baseCooldown', type: 'uint256' },
      { internalType: 'uint256', name: '_cooldownPerGen', type: 'uint256' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_baseSummonFee', type: 'uint256' },
      { internalType: 'uint256', name: '_increasePerSummon', type: 'uint256' },
      { internalType: 'uint256', name: '_increasePerGen', type: 'uint256' },
    ],
    name: 'setSummonFees',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [],
    name: 'statScience',
    outputs: [{ internalType: 'contract IStatScience', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [
      { internalType: 'uint256', name: '_summonerId', type: 'uint256' },
      { internalType: 'uint256', name: '_assistantId', type: 'uint256' },
      { internalType: 'uint16', name: '_summonerTears', type: 'uint16' },
      { internalType: 'uint16', name: '_assistantTears', type: 'uint16' },
      { internalType: 'address', name: '_bonusItem', type: 'address' },
    ],
    name: 'summonCrystal',
    outputs: [],
    stateMutability: 'nonpayable',
