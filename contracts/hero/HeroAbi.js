export default [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'assistantId', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'statGenes', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'visualGenes', type: 'uint256' },
    ],
    name: 'HeroSummoned',
    type: 'event',
  },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_statGenes', type: 'uint256' },
      { internalType: 'uint256', name: '_visualGenes', type: 'uint256' },
      { internalType: 'enum IHeroTypes.Rarity', name: '_rarity', type: 'uint8' },
      { internalType: 'bool', name: '_shiny', type: 'bool' },
      {
        components: [
